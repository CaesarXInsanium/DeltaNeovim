return {
  ...
  keys = {
    ...
    { '<leader>qk',          "<cmd>Telescope keymaps<CR>",                 mode = { 'n' }, desc = "show keybindings" },
    { '<leader>ql',          "<cmd>Lazy<CR>",                              mode = { 'n' }, desc = "Lazy Panel" },
    { '<leader>qh',          "<cmd>set nohlsearch<CR>",                    mode = { 'n' }, desc = "hide search highlighting" },
    { '<leader>qb',          "<cmd>hi Normal guibg=NONE ctermbg=NONE<CR>", mode = { 'n' }, desc = "set clear background" },
    { '<leader>ql',          "<cmd>set background=light<CR>",              mode = { 'n' }, desc = "switch to light mode" },

    { '<leader>ss',          "<cmd>mksession! .session<CR>",               mode = { 'n' }, desc = "Save Session" },
    { '<leader>sl',          "<cmd>source .session<CR>",                   mode = { 'n' }, desc = "Load Session" },
    { '<leader>sr',          "<cmd>!rm .session<CR>",                      mode = { 'n' }, desc = "Delete Session" },
    ...
    { '<leader>C',           "<cmd>cclose<CR>",                            mode = { 'n' }, desc = "Close Quickfix" },
    { '<Tab>j',              "<cmd>cnext<CR>",                             mode = { 'n' }, desc = "Next Error" },
    { '<Tab>k',              "<cmd>cprevious<CR>",                         mode = { 'n' }, desc = "Previous Error" },
